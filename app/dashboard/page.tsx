          ...
          <div className="flex flex-wrap gap-4 items-center justify-between">
            <div className="flex flex-wrap gap-4 items-center">
              <button
                ...
                className="apple-button-primary disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {refreshing ? (
                  <>
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                />
                <span className="apple-body text-apple-gray-700">Auto-refresh (30s)</span>
              </label>
              ...
              {refreshing && (
                <span className="apple-caption text-apple-blue font-semibold">
            ...
            <div className="flex flex-wrap gap-3">
              <span className="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg font-medium">
                📊 Dashboard (Current)
              </span>
              <a 
